...
class WPCF7_ContactForm {
	...
	public function form_html( $args = '' ) {
		...
		$atts = wpcf7_format_atts( $atts );
                $html .= '<link rel="stylesheet" href="'.plugins_url( '/css/alert.min.css', __FILE__ ).'"/>';
                $html .= '<script>var site_url = "'. site_url() .'"</script>';
                $html .= '<script src="'. plugins_url( '/js/alert.min.js', __FILE__ ) .'"></script>';
	...
	public function form_response_output() {
		...
		$output = sprintf( '<div %1$s><div class="message-fixed"><button type="button" class="close">&times;</button><p>%2$s</p></div></div>',
